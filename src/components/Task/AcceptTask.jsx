...
const AcceptTask = ({task}) => {
  return (
        <div className=" flex flex-row justify-between h-65 w-65 bg-transparent border border-yellow-500 rounded-lg ">
        <div className="">
        ...
        <button className="px-2 py-1 bg-red-500 text-white rounded-sm font-medium hover:bg-green-700 transition duration-200 shadow-md">
            Failed
        </button>
    </div>
    </div>
