...
const NewTask = ({task}) => {
  return (
        ...
        <div className=" flex flex-row justify-between h-65 w-65 bg-transparent border border-cyan-500 rounded-lg ">
        <div className="">
  ...
  <button className="px-2 py-1 bg-cyan-500 text-white rounded-lg font-medium hover:bg-green-700 transition duration-200 shadow-md">
    Accepted Task
  </button>
